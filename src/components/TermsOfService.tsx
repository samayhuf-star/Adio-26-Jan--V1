      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">3.1 Eligibility</h3>
            ...
            <h3 className="text-lg font-medium text-gray-700 mt-4 mb-2">3.2 Account Responsibilities</h3>
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">5.1 Plan Types</h3>
            ...
            <h3 className="text-lg font-medium text-gray-700 mt-4 mb-2">5.2 Billing Terms</h3>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h3 className="text-lg font-medium text-gray-700 mt-4 mb-2">5.3 Cancellation</h3>
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">6.1 Our IP</h3>
            ...
            <h3 className="text-lg font-medium text-gray-700 mt-4 mb-2">6.2 Your Content</h3>
          ...
          <section>
            ...
            <ul className="list-none space-y-1">
              <li>Email: <a href="mailto:hello@adiology.io" className="text-violet-600 hover:text-violet-700">hello@adiology.io</a></li>
