...
- **Sitemap & Robots**: `public/sitemap.xml` lists all 41 crawlable path URLs (including 25 blog articles). `public/robots.txt` allows feature pages and blog, blocks dashboard/admin paths.
